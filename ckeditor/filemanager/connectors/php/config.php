...
use PHPMaker2019\acc_prj as PHPMaker;
...
$Config['UserFilesPath'] = PHPMaker\PathCombine($path, 'userfiles/', FALSE); // User files folder under global upload folder
...
$path = PHPMaker\PathCombine(realpath($rootRelativePath), $RELATIVE_PATH, TRUE); // Application root
$path = PHPMaker\PathCombine($path, PHPMaker\UPLOAD_DEST_PATH, TRUE); // Global upload folder
$Config['UserFilesAbsolutePath'] = PHPMaker\PathCombine($path, 'userfiles/', TRUE); // User files folder under global upload folder
