...
// Create page object
$t9996_employees_edit = new t9996_employees_edit();

// Run the page
$t9996_employees_edit->run();
...
$t9996_employees_edit->Page_Render();
?>
...
var ft9996_employeesedit = currentForm = new ew.Form("ft9996_employeesedit", "edit");

// Validate form
ft9996_employeesedit.validate = function() {
	...
	for (var i = startcnt; i <= rowcnt; i++) {
		...
		<?php if ($t9996_employees_edit->EmployeeID->Required) { ?>
			elm = this.getElements("x" + infix + "_EmployeeID");
			if (elm && !ew.isHidden(elm) && !ew.hasValue(elm))
				return this.onError(elm, "<?php echo JsEncode(str_replace("%s", $t9996_employees->EmployeeID->caption(), $t9996_employees->EmployeeID->RequiredErrorMessage)) ?>");
		<?php } ?>
		<?php if ($t9996_employees_edit->LastName->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->FirstName->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->Title->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->TitleOfCourtesy->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->BirthDate->Required) { ?>
		...
		<?php if ($t9996_employees_edit->HireDate->Required) { ?>
		...
		<?php if ($t9996_employees_edit->Address->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->City->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->Region->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->PostalCode->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->Country->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->HomePhone->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->Extension->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->_Email->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->Photo->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->Notes->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->ReportsTo->Required) { ?>
		...
		<?php if ($t9996_employees_edit->Password->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->UserLevel->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->Username->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->Activated->Required) { ?>
		...
		<?php } ?>
		<?php if ($t9996_employees_edit->Profile->Required) { ?>
...
ft9996_employeesedit.Form_CustomValidate = function(fobj) { // DO NOT CHANGE THIS LINE!
...
ft9996_employeesedit.validateRequired = <?php echo json_encode(CLIENT_VALIDATE) ?>;

// Dynamic selection lists
ft9996_employeesedit.lists["x_UserLevel"] = <?php echo $t9996_employees_edit->UserLevel->Lookup->toClientList() ?>;
ft9996_employeesedit.lists["x_UserLevel"].options = <?php echo JsonEncode($t9996_employees_edit->UserLevel->lookupOptions()) ?>;
ft9996_employeesedit.lists["x_Activated[]"] = <?php echo $t9996_employees_edit->Activated->Lookup->toClientList() ?>;
ft9996_employeesedit.lists["x_Activated[]"].options = <?php echo JsonEncode($t9996_employees_edit->Activated->options(FALSE, TRUE)) ?>;
...
<?php $t9996_employees_edit->showPageHeader(); ?>
<?php
$t9996_employees_edit->showMessage();
?>
<form name="ft9996_employeesedit" id="ft9996_employeesedit" class="<?php echo $t9996_employees_edit->FormClassName ?>" action="<?php echo CurrentPageName() ?>" method="post">
<?php if ($t9996_employees_edit->CheckToken) { ?>
<input type="hidden" name="<?php echo TOKEN_NAME ?>" value="<?php echo $t9996_employees_edit->Token ?>">
<?php } ?>
<input type="hidden" name="t" value="t9996_employees">
<input type="hidden" name="action" id="action" value="update">
<input type="hidden" name="modal" value="<?php echo (int)$t9996_employees_edit->IsModal ?>">
...
<?php if ($t9996_employees->EmployeeID->Visible) { // EmployeeID ?>
	<div id="r_EmployeeID" class="form-group row">
		<label id="elh_t9996_employees_EmployeeID" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->EmployeeID->caption() ?><?php echo ($t9996_employees->EmployeeID->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->EmployeeID->cellAttributes() ?>>
<span id="el_t9996_employees_EmployeeID">
<span<?php echo $t9996_employees->EmployeeID->viewAttributes() ?>>
<input type="text" readonly class="form-control-plaintext" value="<?php echo RemoveHtml($t9996_employees->EmployeeID->EditValue) ?>"></span>
</span>
<input type="hidden" data-table="t9996_employees" data-field="x_EmployeeID" name="x_EmployeeID" id="x_EmployeeID" value="<?php echo HtmlEncode($t9996_employees->EmployeeID->CurrentValue) ?>">
<?php echo $t9996_employees->EmployeeID->CustomMsg ?></div></div>
	</div>
<?php } ?>
<?php if ($t9996_employees->LastName->Visible) { // LastName ?>
	<div id="r_LastName" class="form-group row">
		<label id="elh_t9996_employees_LastName" for="x_LastName" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->LastName->caption() ?><?php echo ($t9996_employees->LastName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->LastName->cellAttributes() ?>>
...
<?php if ($t9996_employees->FirstName->Visible) { // FirstName ?>
	<div id="r_FirstName" class="form-group row">
		<label id="elh_t9996_employees_FirstName" for="x_FirstName" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->FirstName->caption() ?><?php echo ($t9996_employees->FirstName->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->FirstName->cellAttributes() ?>>
...
<?php if ($t9996_employees->Title->Visible) { // Title ?>
	<div id="r_Title" class="form-group row">
		<label id="elh_t9996_employees_Title" for="x_Title" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->Title->caption() ?><?php echo ($t9996_employees->Title->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->Title->cellAttributes() ?>>
...
<?php if ($t9996_employees->TitleOfCourtesy->Visible) { // TitleOfCourtesy ?>
	<div id="r_TitleOfCourtesy" class="form-group row">
		<label id="elh_t9996_employees_TitleOfCourtesy" for="x_TitleOfCourtesy" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->TitleOfCourtesy->caption() ?><?php echo ($t9996_employees->TitleOfCourtesy->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->TitleOfCourtesy->cellAttributes() ?>>
...
<?php if ($t9996_employees->BirthDate->Visible) { // BirthDate ?>
	<div id="r_BirthDate" class="form-group row">
		<label id="elh_t9996_employees_BirthDate" for="x_BirthDate" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->BirthDate->caption() ?><?php echo ($t9996_employees->BirthDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->BirthDate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("ft9996_employeesedit", "x_BirthDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($t9996_employees->HireDate->Visible) { // HireDate ?>
	<div id="r_HireDate" class="form-group row">
		<label id="elh_t9996_employees_HireDate" for="x_HireDate" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->HireDate->caption() ?><?php echo ($t9996_employees->HireDate->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->HireDate->cellAttributes() ?>>
...
<script>
ew.createDateTimePicker("ft9996_employeesedit", "x_HireDate", {"ignoreReadonly":true,"useCurrent":false,"format":0});
</script>
<?php } ?>
</span>
...
<?php if ($t9996_employees->Address->Visible) { // Address ?>
	<div id="r_Address" class="form-group row">
		<label id="elh_t9996_employees_Address" for="x_Address" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->Address->caption() ?><?php echo ($t9996_employees->Address->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->Address->cellAttributes() ?>>
...
<?php if ($t9996_employees->City->Visible) { // City ?>
	<div id="r_City" class="form-group row">
		<label id="elh_t9996_employees_City" for="x_City" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->City->caption() ?><?php echo ($t9996_employees->City->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->City->cellAttributes() ?>>
...
<?php if ($t9996_employees->Region->Visible) { // Region ?>
	<div id="r_Region" class="form-group row">
		<label id="elh_t9996_employees_Region" for="x_Region" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->Region->caption() ?><?php echo ($t9996_employees->Region->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->Region->cellAttributes() ?>>
...
<?php if ($t9996_employees->PostalCode->Visible) { // PostalCode ?>
	<div id="r_PostalCode" class="form-group row">
		<label id="elh_t9996_employees_PostalCode" for="x_PostalCode" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->PostalCode->caption() ?><?php echo ($t9996_employees->PostalCode->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->PostalCode->cellAttributes() ?>>
...
<?php if ($t9996_employees->Country->Visible) { // Country ?>
	<div id="r_Country" class="form-group row">
		<label id="elh_t9996_employees_Country" for="x_Country" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->Country->caption() ?><?php echo ($t9996_employees->Country->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->Country->cellAttributes() ?>>
...
<?php if ($t9996_employees->HomePhone->Visible) { // HomePhone ?>
	<div id="r_HomePhone" class="form-group row">
		<label id="elh_t9996_employees_HomePhone" for="x_HomePhone" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->HomePhone->caption() ?><?php echo ($t9996_employees->HomePhone->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->HomePhone->cellAttributes() ?>>
...
<?php if ($t9996_employees->Extension->Visible) { // Extension ?>
	<div id="r_Extension" class="form-group row">
		<label id="elh_t9996_employees_Extension" for="x_Extension" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->Extension->caption() ?><?php echo ($t9996_employees->Extension->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->Extension->cellAttributes() ?>>
...
<?php if ($t9996_employees->_Email->Visible) { // Email ?>
	<div id="r__Email" class="form-group row">
		<label id="elh_t9996_employees__Email" for="x__Email" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->_Email->caption() ?><?php echo ($t9996_employees->_Email->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->_Email->cellAttributes() ?>>
...
<?php if ($t9996_employees->Photo->Visible) { // Photo ?>
	<div id="r_Photo" class="form-group row">
		<label id="elh_t9996_employees_Photo" for="x_Photo" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->Photo->caption() ?><?php echo ($t9996_employees->Photo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->Photo->cellAttributes() ?>>
...
<?php if ($t9996_employees->Notes->Visible) { // Notes ?>
	<div id="r_Notes" class="form-group row">
		<label id="elh_t9996_employees_Notes" for="x_Notes" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->Notes->caption() ?><?php echo ($t9996_employees->Notes->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->Notes->cellAttributes() ?>>
...
<?php if ($t9996_employees->ReportsTo->Visible) { // ReportsTo ?>
	<div id="r_ReportsTo" class="form-group row">
		<label id="elh_t9996_employees_ReportsTo" for="x_ReportsTo" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->ReportsTo->caption() ?><?php echo ($t9996_employees->ReportsTo->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->ReportsTo->cellAttributes() ?>>
...
<?php if ($t9996_employees->Password->Visible) { // Password ?>
	<div id="r_Password" class="form-group row">
		<label id="elh_t9996_employees_Password" for="x_Password" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->Password->caption() ?><?php echo ($t9996_employees->Password->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->Password->cellAttributes() ?>>
...
<?php if ($t9996_employees->UserLevel->Visible) { // UserLevel ?>
	<div id="r_UserLevel" class="form-group row">
		<label id="elh_t9996_employees_UserLevel" for="x_UserLevel" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->UserLevel->caption() ?><?php echo ($t9996_employees->UserLevel->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->UserLevel->cellAttributes() ?>>
...
<?php if ($t9996_employees->Username->Visible) { // Username ?>
	<div id="r_Username" class="form-group row">
		<label id="elh_t9996_employees_Username" for="x_Username" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->Username->caption() ?><?php echo ($t9996_employees->Username->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->Username->cellAttributes() ?>>
...
<?php if ($t9996_employees->Activated->Visible) { // Activated ?>
	<div id="r_Activated" class="form-group row">
		<label id="elh_t9996_employees_Activated" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->Activated->caption() ?><?php echo ($t9996_employees->Activated->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->Activated->cellAttributes() ?>>
...
<?php if ($t9996_employees->Profile->Visible) { // Profile ?>
	<div id="r_Profile" class="form-group row">
		<label id="elh_t9996_employees_Profile" for="x_Profile" class="<?php echo $t9996_employees_edit->LeftColumnClass ?>"><?php echo $t9996_employees->Profile->caption() ?><?php echo ($t9996_employees->Profile->Required) ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
		<div class="<?php echo $t9996_employees_edit->RightColumnClass ?>"><div<?php echo $t9996_employees->Profile->cellAttributes() ?>>
...
<?php if (!$t9996_employees_edit->IsModal) { ?>
<div class="form-group row"><!-- buttons .form-group -->
	<div class="<?php echo $t9996_employees_edit->OffsetColumnClass ?>"><!-- buttons offset -->
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit"><?php echo $Language->phrase("SaveBtn") ?></button>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-href="<?php echo $t9996_employees_edit->getReturnUrl() ?>"><?php echo $Language->phrase("CancelBtn") ?></button>
	</div><!-- /buttons offset -->
</div><!-- /buttons .form-group -->
<?php } ?>
</form>
<?php
$t9996_employees_edit->showPageFooter();
if (DEBUG_ENABLED)
...
<?php
$t9996_employees_edit->terminate();
?>