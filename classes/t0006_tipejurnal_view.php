 ...
 * Page class
 */
class t0006_tipejurnal_view extends t0006_tipejurnal
{
	...
	// Page object name
	public $PageObjName = "t0006_tipejurnal_view";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canView()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t0006_tipejurnallist.php"));
				else
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID") !== NULL) {
				...
				$returnUrl = "t0006_tipejurnallist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t0006_tipejurnallist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t0006_tipejurnallist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t0006_tipejurnallist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
