 ...
 * Page class
 */
class t9999_audittrail_delete extends t9999_audittrail
{
	...
	// Page object name
	public $PageObjName = "t9999_audittrail_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t9999_audittraillist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecs <= 0) { // No record found, exit
				...
				$this->terminate("t9999_audittraillist.php"); // Return to list
			}
		}
	}
