 ...
 * Page class
 */
class t9998_userlevelpermissions_view extends t9998_userlevelpermissions
{
	...
	// Page object name
	public $PageObjName = "t9998_userlevelpermissions_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("userlevelid") !== NULL) {
				...
				$returnUrl = "t9998_userlevelpermissionslist.php"; // Return to list
			}
			if (Get("_tablename") !== NULL) {
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t9998_userlevelpermissionslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t9998_userlevelpermissionslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
