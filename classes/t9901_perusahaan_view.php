 ...
 * Page class
 */
class t9901_perusahaan_view extends t9901_perusahaan
{
	...
	// Page object name
	public $PageObjName = "t9901_perusahaan_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("id") !== NULL) {
				...
				$returnUrl = "t9901_perusahaanlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t9901_perusahaanlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t9901_perusahaanlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
