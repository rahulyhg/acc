 ...
 * Page class
 */
class t0004_jurnal_add extends t0004_jurnal
{
	...
	// Page object name
	public $PageObjName = "t0004_jurnal_add";
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			if (!$Security->canAdd()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("t0004_jurnallist.php"));
				else
		...
		switch ($this->CurrentAction) {
			case "copy": // Copy an existing record
				if (!$loaded) { // Record not loaded
					...
					$this->terminate("t0004_jurnallist.php"); // No matching record, return to list
				}
				break;
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					if (GetPageName($returnUrl) == "t0004_jurnallist.php")
						$returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
					elseif (GetPageName($returnUrl) == "t0004_jurnalview.php")
	...
	protected function validateForm()
	{
		...
		if (!CheckInteger($this->Tipe->FormValue)) {
			AddMessage($FormError, $this->Tipe->errorMessage());
		}
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("t0004_jurnallist.php"), "", $this->TableVar, TRUE);
