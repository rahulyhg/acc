 ...
 * Page class
 */
class userpriv extends t9997_userlevels
{
	...
	public function __construct()
	{
		...
		if (!isset($GLOBALS["t9997_userlevels"]))
			$GLOBALS["t9997_userlevels"] = &$this;
	...
	public function run()
	{
		...
		if (!$validRequest) {
			...
			$Security->loadCurrentUserLevel(CurrentProjectID() . 't9997_userlevels');
			if ($Security->isLoggedIn())
		...
		$Breadcrumb->add("list", "t9997_userlevels", "t9997_userlevelslist.php", "", "t9997_userlevels");
