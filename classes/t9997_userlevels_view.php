 ...
 * Page class
 */
class t9997_userlevels_view extends t9997_userlevels
{
	...
	// Page object name
	public $PageObjName = "t9997_userlevels_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("userlevelid") !== NULL) {
				...
				$returnUrl = "t9997_userlevelslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t9997_userlevelslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t9997_userlevelslist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
