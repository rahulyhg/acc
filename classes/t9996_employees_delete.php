 ...
 * Page class
 */
class t9996_employees_delete extends t9996_employees
{
	...
	// Page object name
	public $PageObjName = "t9996_employees_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("t9996_employeeslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($rs = LoadRecordset($sql, $conn)) {
			...
			$rs->close();
			if (!$res) {
				$this->terminate("t9996_employeeslist.php"); // Return to list
				return;
			}
		}
