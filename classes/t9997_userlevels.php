...
/**
 * Table class for t9997_userlevels
 */
class t9997_userlevels extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't9997_userlevels';
		$this->TableName = 't9997_userlevels';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t9997_userlevels`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// userlevelid
		$this->userlevelid = new DbField('t9997_userlevels', 't9997_userlevels', 'x_userlevelid', 'userlevelid', '`userlevelid`', '`userlevelid`', 3, -1, FALSE, '`userlevelid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// userlevelname
		$this->userlevelname = new DbField('t9997_userlevels', 't9997_userlevels', 'x_userlevelname', 'userlevelname', '`userlevelname`', '`userlevelname`', 200, -1, FALSE, '`userlevelname`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`t9997_userlevels`";
	}
	...
	{
		return ($this->SqlOrderBy <> "") ? $this->SqlOrderBy : USER_LEVEL_ID_FIELD;
	}
	...
	public function getReturnUrl()
	{
		...
		if (@$_SESSION[$name] <> "") {
			...
			return "t9997_userlevelslist.php";
		}
	}
	...
	{
		global $Language;
		if ($pageName == "t9997_userlevelsview.php")
			return $Language->phrase("View");
		elseif ($pageName == "t9997_userlevelsedit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t9997_userlevelsadd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("t9997_userlevelsview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t9997_userlevelsview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "t9997_userlevelsadd.php?" . $this->getUrlParm($parm);
		else
			$url = "t9997_userlevelsadd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t9997_userlevelsedit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t9997_userlevelsadd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t9997_userlevelsdelete.php", $this->getUrlParm());
	}
	...
	public function renderEditRow()
	{
		...
		if (in_array($this->userlevelid->CurrentValue, [-2, -1, 0])) $this->userlevelname->ReadOnly = TRUE;
