 ...
 * Page class
 */
class t0004_jurnal_list extends t0004_jurnal
{
	...
	// Table name
	public $TableName = 't0004_jurnal';

	// Page object name
	public $PageObjName = "t0004_jurnal_list";

	// Grid form hidden field names
	public $FormName = "ft0004_jurnallist";
	...
	public function __construct()
	{
		...
		// Table object (t0004_jurnal)
		if (!isset($GLOBALS["t0004_jurnal"]) || get_class($GLOBALS["t0004_jurnal"]) == PROJECT_NAMESPACE . "t0004_jurnal") {
			$GLOBALS["t0004_jurnal"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["t0004_jurnal"];
		}
		...
		$this->AddUrl = "t0004_jurnaladd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "t0004_jurnaldelete.php";
		$this->MultiUpdateUrl = "t0004_jurnalupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 't0004_jurnal');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option ft0004_jurnallistsrch";
	...
	public function getFilterList()
	{
		...
		$filterList = Concat($filterList, $this->Deskripsi->AdvancedSearch->toJson(), ","); // Field Deskripsi
		if ($this->BasicSearch->Keyword <> "") {
	...
	protected function processFilterList()
	{
		...
		if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
			...
			$UserProfile->setSearchFilters(CurrentUserName(), "ft0004_jurnallistsrch", $filters);
	...
	protected function basicSearchSql($arKeywords, $type)
	{
		...
		$this->buildBasicSearchSql($where, $this->Deskripsi, $arKeywords, $type);
		return $where;
	}
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"ft0004_jurnallistsrch\" href=\"#\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = TRUE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"ft0004_jurnallistsrch\" href=\"#\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = TRUE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"\" onclick=\"ew.submitAction(event,jQuery.extend({f:document.ft0004_jurnallist}," . $listaction->toJson(TRUE) . "));return false;\">" . $icon . "</a>";
	...
	protected function setupSearchOptions()
	{
		...
		$item->Body = "<button type=\"button\" class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-toggle=\"button\" data-form=\"ft0004_jurnallistsrch\">" . $Language->phrase("SearchLink") . "</button>";
		$item->Visible = TRUE;
	...
	public function renderRow()
	{
		...
		if ($this->RowType == ROWTYPE_VIEW) { // View row
			...
			$this->Tipe->ViewValue = FormatNumber($this->Tipe->ViewValue, 0, -2, -2, -2);
