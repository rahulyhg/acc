 ...
 * Page class
 */
class t0001_kelompokakun_view extends t0001_kelompokakun
{
	...
	// Page object name
	public $PageObjName = "t0001_kelompokakun_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID") !== NULL) {
				...
				$returnUrl = "t0001_kelompokakunlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t0001_kelompokakunlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t0001_kelompokakunlist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
