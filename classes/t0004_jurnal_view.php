 ...
 * Page class
 */
class t0004_jurnal_view extends t0004_jurnal
{
	...
	// Page object name
	public $PageObjName = "t0004_jurnal_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID") !== NULL) {
				...
				$returnUrl = "t0004_jurnallist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "t0004_jurnallist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "t0004_jurnallist.php"; // Not page request, return to list
		}
		if ($returnUrl <> "") {
