...
/**
 * Table class for t0004_jurnal
 */
class t0004_jurnal extends DbTable
{
	protected $SqlFrom = "";
	protected $SqlSelect = "";
	...
	public function __construct()
	{
		...
		$this->TableVar = 't0004_jurnal';
		$this->TableName = 't0004_jurnal';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`t0004_jurnal`";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID
		$this->ID = new DbField('t0004_jurnal', 't0004_jurnal', 'x_ID', 'ID', '`ID`', '`ID`', 200, -1, FALSE, '`ID`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Tipe
		$this->Tipe = new DbField('t0004_jurnal', 't0004_jurnal', 'x_Tipe', 'Tipe', '`Tipe`', '`Tipe`', 17, -1, FALSE, '`Tipe`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Tanggal
		$this->Tanggal = new DbField('t0004_jurnal', 't0004_jurnal', 'x_Tanggal', 'Tanggal', '`Tanggal`', CastDateFieldForLike('`Tanggal`', 0, "DB"), 133, 0, FALSE, '`Tanggal`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Deskripsi
		$this->Deskripsi = new DbField('t0004_jurnal', 't0004_jurnal', 'x_Deskripsi', 'Deskripsi', '`Deskripsi`', '`Deskripsi`', 201, -1, FALSE, '`Deskripsi`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXTAREA');
	...
	{
		return ($this->SqlFrom <> "") ? $this->SqlFrom : "`t0004_jurnal`";
	}
	...
	{
		global $Language;
		if ($pageName == "t0004_jurnalview.php")
			return $Language->phrase("View");
		elseif ($pageName == "t0004_jurnaledit.php")
			return $Language->phrase("Edit");
		elseif ($pageName == "t0004_jurnaladd.php")
	...
	{
		if ($parm <> "")
			$url = $this->keyUrl("t0004_jurnalview.php", $this->getUrlParm($parm));
		else
			$url = $this->keyUrl("t0004_jurnalview.php", $this->getUrlParm(TABLE_SHOW_DETAIL . "="));
	...
	{
		if ($parm <> "")
			$url = "t0004_jurnaladd.php?" . $this->getUrlParm($parm);
		else
			$url = "t0004_jurnaladd.php";
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t0004_jurnaledit.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		$url = $this->keyUrl("t0004_jurnaladd.php", $this->getUrlParm($parm));
		return $this->addMasterUrl($url);
	}
	...
	{
		return $this->keyUrl("t0004_jurnaldelete.php", $this->getUrlParm());
	}
